...
class FolderProcessor:
    ...
    def _move_file_to_destination(self, file_path, destination_folder, normalized_name):
        ...
        file_path = self.standardize_path(file_path)
        destination_folder = self.standardize_path(destination_folder)
        
        file_name = os.path.basename(file_path)

        # Clean filename for destination using our helper method
        clean_brace_file_name = self._remove_braces_from_string(file_name)
